            ...
            <div className="fixed z-10 left-[12%] sm:left-[25%] md:left-[30%] lg:left-[35%]">
                ...
                <div className='absolute top-[6vh] sm:top-[8vh] md:top-[0vh]'>
                    <div className='bg-[#303030] w-80 sm:w-96 rounded p-4 '>
                        ...
                        <div className="flex justify-end">
                            <div className="bg-red-600 mt-2 mr-2 p-1 rounded text-center text-sm hover:bg-red-400 transition-all">
                                <a href="https://forms.gle/Rf9DY7tSqtQigdep9" className="text-white">Fill this form after payment</a>
                            </div>
                            {/* <a ></a></div> */}
                         </div>   
                        <div className="mt-2 text-xs"><u>Note:</u> We will be mailing the tickets to you 1-2 days before the event.</div>

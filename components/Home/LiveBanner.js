...
const LiveBanner = ({ imageUrl, title, details }) => {
  ...
  >
    ...
    >
      ...
      <p className="col-span-2 row-span-2 text-justify w-11/12 mx-auto -mt-1 mb-4 text-xs sm:text-lg md:text-lg" >{details}</p>
      <button className="col-start-3 sm:row-span-2 row-span-full w-3/4 h-3/4 bg-red-600 mx-auto sm:text-lg md:text-xl h-3/6"
      >Live Now</button>

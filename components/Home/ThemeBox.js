...
const ThemeBar = () => {
  ...
  if (isLargeViewPort)
    return (
      <>
        <div className="mx-auto flex justify-around bg-black">
          <article className="grid grid-cols-5 grid-rows-3 h-[30rem] w-[58rem] lg:w-[65rem] 2xl:h-[36rem] 2xl:w-[85rem] gap-6 bg-red-600 mt-32 mb-20">
  ...
  if (!isLargeViewPort)
    return (
      <div className="flex justify-center bg-black">
        <div className=" bg-red-600 min-w-[10%] max-w-sm max-h-32 md:max-w-md min-h-[70vh] md:h-[80vh] grid grid-cols-4  grid-rows-8 text-white">
          ...
          <div className="bg-red-400 col-span-3 row-span-4 m-4"></div>
